...
object Constants {
    ...
    fun getQuestions(): ArrayList<Question> {
        ...
        val que1 = Question(
            ...
            R.drawable.one,
            "1 Million", "5 Million",
            "10 Million", "If I do, I won't be able to graduate!", 4
        )
        ...
        // 2
        val que2 = Question(
            2, "Which is the best department of BRACU?",
            R.drawable.two,
            "CSE!", "Choose Option 1!",
        ...
        // 3
        val que3 = Question(
            3, "Identify the following word!",
            R.drawable.three,
            "Fruit", "Color",
            "Brand", "All of the above", 4
        )
